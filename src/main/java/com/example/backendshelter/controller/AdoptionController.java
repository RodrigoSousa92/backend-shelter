...
import com.example.backendshelter.controller.request.UpdatePetNameRQ;
...
public class AdoptionController {
    ...
    public ResponseEntity<PetResponse> updatePetName(@PathVariable Long id, @RequestBody UpdatePetNameRQ request) {
